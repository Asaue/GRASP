...
# Inference Start
export CHECKPOINT='/Data/Docker_liuwu/models/PaDT_Pro_3B'
...
do
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --master_port="12369" --nproc_per_node=4 inference_refcoco.py $CHECKPOINT $SPLIT $LOG_SUFFIX
