...
# question prompt
# PROMPT = """Please carefully check the image and detect the object this sentence describes: "The horizontal portion in the ground crack"."""
PROMPT = """Please carefully check the image and detect the object this sentence describes: "The crack extending from the middle to the upper right"."""
...
cv2.imwrite('/home/yrquni/Downloads/Unilab/PaDT/outputs/mask_seg.png', mask_seg)
cv2.imwrite('/home/yrquni/Downloads/Unilab/PaDT/outputs/pred_box.png', image)
cv2.imwrite('/home/yrquni/Downloads/Unilab/PaDT/outputs/vrt_seg.png', vrt_seg * 0.6 + image * 0.4)